void QpeAPMacro(){
	...
	TFile *file=new TFile("outputNoise_3.root", "READ");
	TFile *outfile=new TFile("gainfits05_3.root", "RECREATE");
	ofstream infofile;
	infofile.open("Qpe05_3.dat");
	...
	//Fitting data
	TF1 *fun=new TF1("FitFun1", "gaus(0)", -2.e-11 ,2.e-11);  //0:ampiezza 1:media 2:sigma +gaus(3) 3:ampiezza 4:media ...
	TF1 *fun2=new TF1(Form("FitFun2_%d", k), "gaus(0)+gaus(3)", -2.e-11 ,3.e-10);
	...
	fun2->SetParLimits(3, 5, fun->GetParameter(0)/100);
